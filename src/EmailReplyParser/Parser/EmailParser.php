...
class EmailParser
{
    ...
    private $quoteHeadersRegex = array(
        ...
        '/(From.*:.+\s?<.+>)/s', // "From: NAME <EMAIL>" OR "From : NAME <EMAIL>" OR "From : NAME<EMAIL>"(With support whitespace before start and before <)
        '/(De.*:.+\s?<.+>)/s', // "De: NAME <EMAIL>" OR "De : NAME <EMAIL>" OR "De : NAME<EMAIL>"  (With support whitespace before start and before <)
